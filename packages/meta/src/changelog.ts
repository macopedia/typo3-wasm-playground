...
const LABEL_TYPE_MAPPING: Record<string, string> = {
	...
	'[Package][@typo3-playground] Blueprints': 'Blueprints',
	'[Package][@typo3-playground] Client': 'Public API',
	'[Package][@typo3-playground] Remote': 'Website',
	'[Package][@typo3-playground] Storage': 'Experiments',
	'[Package][@typo3-playground] Sync': 'Experiments',
	'[Package][@typo3-playground] Website': 'Website',
	'[Package][@typo3-playground] WordPress': 'Website',
...
const LABEL_FEATURE_MAPPING: Record<string, string> = {
	...
	'[Package][@php-wasm] Web': 'PHP WebAssembly',
	'[Package][@typo3-playground] Blueprints': 'Blueprints',
	'[Package][@typo3-playground] Client': 'Blueprints',
	'[Package][@typo3-playground] Storage': 'GitHub integration',
	'[Package][@typo3-playground] Remote': 'Website',
	'[Package][@typo3-playground] Website': 'Website',
	'[Package][@typo3-playground] WordPress': 'Website',
	'[Type] Developer Documentation': 'Documentation',
