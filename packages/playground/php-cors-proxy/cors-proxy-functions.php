...
function should_respond_with_cors_headers($host, $origin) {
    ...
    $is_request_from_playground_web_app = $origin === 'https://typo3-playground-edc132.macopedia.io';
    $not_hosted_with_playground_web_app = $host !== 'typo3-playground-edc132.macopedia.io';
    if (
