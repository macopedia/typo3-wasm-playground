import { Blueprint } from '@typo3-playground/client';
...
export async function resolveBlueprintFromURL(url: URL) {
	...
	blueprint.preferredVersions!.php =
		(query.get('php') as any) || blueprint.preferredVersions!.php || '8.2';
	blueprint.preferredVersions!.t3 =
		query.get('t3') || blueprint.preferredVersions!.t3 || '13.4';
