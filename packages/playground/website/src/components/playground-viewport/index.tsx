...
export const JustViewport = function JustViewport({
	...
	return (
		<iframe
			key={siteSlug}
			title="TYPO3 Playground wrapper (the actual TYPO3 site is in another, nested iframe)"
	...
	if (
		...
		return (
			<>
				...
				<p>
					You previously granted TYPO3 Playground access to your local
					directory, but the browser no longer allows Playground to
					access it.
				</p>
				<p>
