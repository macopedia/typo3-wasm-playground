export * from '@typo3-playground/blueprints';
...
export async function startPlaygroundWeb({
	...
	progressTracker.setCaption('Preparing TYPO3');
	...
	await playground.boot({
		...
		t3Version: compiled.versions.t3,
...
const officialRemoteOrigin = 'https://typo3-playground-edc132.macopedia.io';
