...
export default defineConfig({
	...
	plugins: [
		...
		// @typo3-playground/client doesn't actually use the remote-config virtual
		// module, @typo3-playground/remote package does. @typo3-playground/client imports
		// a few things from @typo3-playground/remote and, even though it doesn't
