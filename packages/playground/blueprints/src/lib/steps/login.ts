 ...
 * This step depends on the `@typo3-playground/typo3` package because
 * the plugin is located in and loaded automatically by the `@typo3-playground/typo3` package.
 */
