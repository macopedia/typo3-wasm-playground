...
const schema11 = {
	...
	definitions: {
		Blueprint: {
			...
			properties: {
				...
				preferredVersions: {
					...
					properties: {
						...
						t3: {
							type: 'string',
							description:
								'The preferred TYPO3 version to use. If not specified, the latest supported version will be used',
						},
					},
					required: ['php', 't3'],
					additionalProperties: false,
					description: 'The preferred PHP and TYPO3 versions to use.',
				},
				features: {
					type: 'object',
					properties: {
				...
				siteOptions: {
					...
					description: 'TYPO3 site options to define',
				},
				login: {
					anyOf: [
						{ type: 'boolean' },
		...
		SupportedPHPVersion: { type: 'string', enum: ['8.4', '8.3', '8.2'] },
...
const schema13 = { type: 'string', enum: ['8.4', '8.3', '8.2'] };
																...
																[
																	{
																		instancePath:
																			instancePath +
																			'/preferredVersions/t3',
																		schemaPath:
																			'#/properties/preferredVersions/properties/t3/type',
																		keyword:
																			'type',
																		params: {
																			type: 'string',
