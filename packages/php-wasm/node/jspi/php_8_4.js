...
export const dependenciesTotalSize = 18551014;
export function init(RuntimeName, PHPLoader) {
	...
	var Asyncify = {
		...
		instrumentWasmExports(exports) {
			var exportPattern =
				/^(wasm_sleep|wasm_read|emscripten_sleep|wasm_sapi_handle_request|wasm_sapi_request_shutdown|wasm_poll_socket|wrap_select|__wrap_select|select|php_pollfd_for|fflush|wasm_popen|wasm_read|wasm_php_exec|run_cli|main|__main_argc_argv)$/;
	...
	var wasmImports = {
		/** @export */ SharpYuvConvert: _SharpYuvConvert,
		/** @export */ SharpYuvGetConversionMatrix:
			_SharpYuvGetConversionMatrix,
		/** @export */ SharpYuvInit: _SharpYuvInit,
		...
		/** @export */ __asyncjs__js_popen_to_file: __asyncjs__js_popen_to_file,
